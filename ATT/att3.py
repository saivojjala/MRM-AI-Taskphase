...
#q1
# latitude: 49.9000384375
# longitude: 8.90005111572

#q2
# latitude: 49.9000313461
# longitude: 8.89996627399

# q3
# latitude: 49.8999568397
# longitude: 8.89993535961

#q4
# latitude: 49.8999610322
# longitude: 8.90004490641
...
class autonomous:
    ...
    def __init__(self):
        ...
        self.lat_final = 49.9000384375
        self.lng_final = 8.90005111572
        self.imu = 0
        self.yaw_initial = 0
        self.fw_azimuth = 0
        self.bw_azimuth = 0
        ...
        while not rospy.is_shutdown():
            ...
            if(self.fw_azimuth > self.yaw_initial):
                ...
                if(self.fw_azimuth - self.yaw_initial<180):
                    ...
                    if(self.fw_azimuth - self.yaw_initial > 1):
                    ...
                    if(self.yaw_initial - self.fw_azimuth > 1):
                        velocity.angular.z = -0.1
                        pub.publish(velocity)
